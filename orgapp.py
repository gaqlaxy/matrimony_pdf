...
"""
        ...
        for field, (x, y) in FIELD_POSITIONS.items():
            ...
            if value:
                ...
                font_size = "15pt" if value.isascii() else "15pt"
                

                # if value.isascii():
                #     font_family = "'Arial', sans-serif"
                #     font_size = "40pt"   # slightly larger to match Tamil Latha
                # else:
        ...
        for dct in (RAASI_POSITIONS, NAVAMSA_POSITIONS):
            for field, (x, y) in dct.items():
                ...
                if value:
                    ...
                    if value.isascii():
                        font_family = "'Arial', sans-serif"
                        font_size = "10pt"   # was 9 → slightly increased
                    else:
                        font_family = "'Latha', sans-serif"
                        font_size = "8pt"
                    ...
                    html_content += (
                        ...
                        f"text-align:center; font-family:{font_family}; font-size:{font_size}; font-weight:bold; "
                        f"white-space:pre-wrap; word-break:break-word;'>"
                        f"{safe_value}</div>\n"
                    )

        # --- Fields (all Latha Bold) new version with bold  ---
        # for field, (x, y) in FIELD_POSITIONS.items():
        #     value = form_data.get(field, "")
        #     if value:
        #         left = x
        ...
        #         html_content += (
        #             f"<div class='field' style='left:{left}pt; top:{top}pt; "
        #             f"font-family:'Latha', sans-serif; font-size:{font_size}; font-weight:bold;'>"
        #             f"{safe_value}</div>\n"
        #         )

        # # --- Raasi + Navamsa (all Latha Bold) ---
        # for dct in (RAASI_POSITIONS, NAVAMSA_POSITIONS):
        #     for field, (x, y) in dct.items():
        #         value = form_data.get(field, "")
        #         if value:
        ...
        #                 f"<div class='field' style='left:{left}pt; top:{top}pt; "
        #                 f"width:60pt; height:30pt; display:flex; align-items:center; justify-content:center; "
        #                 f"text-align:center; font-family:'Latha', sans-serif; font-size:{font_size}; font-weight:bold; "
        #                 f"white-space:pre-wrap; word-break:break-word;'>"
        #                 f"{safe_value}</div>\n"
        #             )
